...
func TestIpfsHandler(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "406 on non-CAR Accept without extract support",
			method:     "GET",
			path:       "/ipfs/bafybeic56z3yccnla3cutmvqsn5zy3g24muupcsjtoyp3pu5pm5amurjx4",
			headers:    map[string]string{"Accept": "application/json"},
			wantStatus: http.StatusNotAcceptable,
			wantBody:   "this endpoint only supports CAR responses; set Accept: application/vnd.ipld.car\n",
		},
		{
		...
		{
			name:       "406 on invalid format query param without extract support",
			method:     "GET",
		...
		{
			name:       "406 on missing Accept header without extract support",
			method:     "GET",
			path:       "/ipfs/bafybeic56z3yccnla3cutmvqsn5zy3g24muupcsjtoyp3pu5pm5amurjx4",
			wantStatus: http.StatusNotAcceptable,
			wantBody:   "this endpoint only supports CAR responses; set Accept: application/vnd.ipld.car\n",
