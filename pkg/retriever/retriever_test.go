			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(25*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerA, nil, cid1), 1, 2, 3*time.Second, big.Zero(), 55),
			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(10*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerB, nil, cid1), 10, 11, 12*time.Second, big.Zero(), 50),
			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(55*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerA, nil, cid1), 1, 2, 3*time.Second, big.Zero(), 55),
			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(55*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerB, nil, cid1), 1, 2, 3*time.Second, big.Zero(), 55),
						events.Finished(startTime.Add(55*time.Millisecond+initialPause), rid, startTime, types.RetrievalCandidate{RootCid: cid1})},
				},
			},
		},
			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(505*time.Millisecond), rid, startTime, types.NewRetrievalCandidate(peerA, nil, cid1), 10, 20, 30*time.Second, big.Zero(), 44),
			...
			expectedSequence: []testutil.ExpectedActionsAtTime{
				...
				},
				{
					...
					ExpectedEvents: []types.RetrievalEvent{
						...
						events.Success(startTime.Add(202*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerB, nil, cid1), 20, 30, 40*time.Second, big.Zero(), 50),
		...
		ExpectedSequence: []testutil.ExpectedActionsAtTime{
			...
			},
			{
				...
				ExpectedEvents: []types.RetrievalEvent{
					...
					events.Success(startTime.Add(10*time.Millisecond+initialPause), rid, startTime, types.NewRetrievalCandidate(peerA, nil, cid1), 1, 2, 3*time.Second, big.Zero(), 55),
					events.Finished(startTime.Add(10*time.Millisecond+initialPause), rid, startTime, types.RetrievalCandidate{RootCid: cid1})},
			},
		},
		...
		ExpectedSequence: []testutil.ExpectedActionsAtTime{
			...
			},
			{
				...
				ExpectedEvents: []types.RetrievalEvent{
					...
					events.Success(startTime.Add((10*time.Millisecond+initialPause)*2), rid, startTime.Add(10*time.Millisecond+initialPause), types.NewRetrievalCandidate(peerB, nil, cid1), 10, 11, 12*time.Second, big.Zero(), 50),
